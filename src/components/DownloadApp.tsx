            ...
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              ...
              <div className="lg:col-span-7 text-left space-y-4">
                <span className="inline-flex items-center px-3.5 py-1 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-xs font-semibold text-blue-100">
                  📱កម្មវិធីលើទូរស័ព្ទ និងគេហទំព័រ
                </span>

                <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white tracking-tight leading-tight">
                  ត្រៀមខ្លួន ដើម្បីលើកកម្ពស់ការសិក្សារបស់អ្នករួចហើយឬនៅ?
                </h2>

                <p className="text-base sm:text-lg text-blue-50/95 font-normal leading-relaxed max-w-xl">
                  ទាញយកកម្មវិធី SaHak នៅថ្ងៃនេះលើ iOS និង Android
                  ដើម្បីស្វែងរកមិត្តសិក្សាដែលសមស្រប
                  ចូលរួមបន្ទប់សិក្សាជាក្រុមផ្ទាល់
                  និងចាប់ផ្តើមទទួលបានរង្វាន់ជាទឹកប្រាក់។
                </p>
                ...
                <div className="pt-4 flex flex-wrap items-center gap-4">
                  ...
                  >
                    <svg className="w-7 h-7" viewBox="0 0 24 24">
                      <path
                        fill="#410593"
                        d="M3.609 1.814L13.792 12 3.61 22.186a2.372 2.372 0 0 1-.61-1.637V3.451c0-.623.226-1.201.609-1.637z"
                      />
                      <path
                        fill="#00e676"
                        d="M17.472 8.32L4.664.927A2.37 2.37 0 0 0 3.61 1.814L13.792 12l3.68-3.68z"
                      />
                      <path
                        fill="#ff3d00"
                        d="M3.61 22.186a2.368 2.368 0 0 0 1.054.887l12.808-7.393L13.792 12 3.61 22.186z"
                      />
                      <path
                        fill="#ffc107"
                        d="M21.144 10.435l-3.672-2.115L13.792 12l3.68 3.68 3.672-2.115a1.81 1.81 0 0 0 0-3.13z"
                      />
                    </svg>
                    <div className="text-left leading-tight">
                      <span className="text-[10px] uppercase font-semibold text-gray-500 block">
              ...
              <div className="lg:col-span-5 flex justify-center lg:justify-end">
                <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6 text-center text-white max-w-xs shadow-xl">
                  ...
                  <h3 className="text-lg font-bold mb-1 text-white">
                    ចូលរួមជាមួយនិស្សិតច្រើនជាង 5,000 នាក់
                  </h3>
                  <p className="text-xs text-blue-100 font-normal">
                    ចាប់ផ្តើមបទពិសោធន៍សិក្សាថ្មីជាមួយគ្នា។ ទាញយក SaHak ថ្ងៃនេះ
                    សម្រាប់ iOS និង Android នៅទូទាំងកម្ពុជា។
                  </p>
                </div>
              </div>
            </div>
